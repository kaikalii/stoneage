...
$execute if score #temp chalc matches 1 if items entity @s $(equipment_hand) #chalc:mending_not_allowed run return run title @s actionbar {"text": "The mending magic rejects this item", color: aqua}
