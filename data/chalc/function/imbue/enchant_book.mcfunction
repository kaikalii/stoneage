...
execute if items entity @s weapon.mainhand book[custom_data~{max_level:4b}] run advancement grant @s only chalc:story/powerful_book
execute if items entity @s weapon.offhand book[custom_data~{max_level:4b}] run advancement grant @s only chalc:story/powerful_book
