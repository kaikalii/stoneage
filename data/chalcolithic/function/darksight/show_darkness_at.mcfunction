...
execute if predicate chalcolithic:dark_inside run return run particle dust{color:[0,0,0],scale:1} ~ ~ ~ 0 0 0 0 1 normal @s
execute if predicate chalcolithic:dark_outside run particle dust{color:[0,0,0.3],scale:1} ~ ~ ~ 0 0 0 0 1 normal @s
